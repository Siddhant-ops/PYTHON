...
# run your function on a test version of the board list,
...
def win_check(board, mark):
    ...
    return (
        ...
        or (board[4] == mark and board[5] == mark and board[6] == mark)  # across the top
        or (board[1] == mark and board[2] == mark and board[3] == mark)  # across the middle
        or (board[7] == mark and board[4] == mark and board[1] == mark)  # across the bottom
        or (board[8] == mark and board[5] == mark and board[2] == mark)  # down the middle
        or (board[9] == mark and board[6] == mark and board[3] == mark)  # down the middle
        or (board[7] == mark and board[5] == mark and board[3] == mark)  # down the right side
